...
export const fetchDefaultPlaylists = () => async (dispatch) => {
  ...
  dispatch({
    type: ActionType.FETCH_DEFAULT_PLAYLISTS,
    payload: {
...
export const fetchArtistInfo = (id) => async (dispatch) => {
  dispatch({
    type: ActionType.HIDE_ARTIST_PAGE,
  });
  ...
  dispatch({
    type: ActionType.FETCH_ARTIST_INFO,
    payload: { info: data, albums, tracks },
  });
  dispatch({
    type: ActionType.SHOW_ARTIST_PAGE,
  });
};

export const fetchAlbumInfo = (id) => async (dispatch) => {
  dispatch({
    type: ActionType.HIDE_ALBUM_PAGE,
  });
  ...
  dispatch({
    type: ActionType.FETCH_ALBUM,
    payload: data,
  });
  dispatch({
    type: ActionType.SHOW_ALBUM_PAGE,
  });
};

export const setCurrentTrack = (payload) => async (dispatch) => {
  dispatch({ type: ActionType.SHOW_TRACK_LOADING });
...
export const setVideoID = (query) => async (dispatch) => {
  ...
  dispatch({
    type: ActionType.FETCH_VIDEO_ID,
    payload: data.id,
  });
  dispatch({ type: ActionType.SHOW_PLAYER });
};
...
export const search = (query, cancelToken) => async (dispatch) => {
  dispatch({ type: ActionType.HIDE_SEARCH }); //hide search loading spinner
  ...
  dispatch({ type: ActionType.SHOW_SEARCH });
};
...
export const setSearchBarFocus = (bool) => (dispatch) => {
  dispatch({
    type: ActionType.SEARCH_BAR_FOCUS,
    payload: bool,
  });
};
...
export const searchFriend = (query, cancelToken) => async (dispatch) => {
  try {
    ...
    dispatch({
      type: ActionType.SET_FIND_USER_RESULT,
      payload: data,
    });
  } catch (error) {
    dispatch({
...
export const addFriendError = (error) => async (dispatch) => {
  dispatch({
    type: ActionType.SET_ADD_FRIEND_ERROR,
    payload: error,
  });
};
...
export const fetchFriendList = () => async (dispatch) => {
  try {
    ...
    dispatch({
      type: ActionType.SET_FRIEND_LIST,
...
export const createSocketConnection = (username) => async (dispatch) => {
  ...
  socket.connect();
  dispatch({
    type: ActionType.SET_SOCKET_CONNECTION,
    payload: socket,
  });
};
